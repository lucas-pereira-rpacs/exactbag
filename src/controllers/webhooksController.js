...
exports.handlePartnerSale = async (req, res) => {
  try {
    ...
    const customerData = {
      ...
      customerEmail:
        body.customerEmail || (body.customer && body.customer.email),
      customerPhone:
        body.customerPhone || (body.customer && body.customer.phone),
    ...
    const productCode =
      body.productCode === undefined || body.productCode === null
        ? null
